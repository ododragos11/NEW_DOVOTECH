    ...
    return showFinal ? (
        <>
            <Modal.Header>
                ...
                <span className="uppercase font-bold  "> Polaris RZR Storage Bags SET of 2</span>!
            </Modal.Header>
            ...
            <Modal.Body>
                <div className="space-y-4">
                    ...
                    <p className="text-base text-center leading-relaxed text-gray-700 dark:text-gray-400">
                        ...
                        Golf brush for cleaning and you should recieve it in the mentioned time
                        frame.
                    </p>
                </div>
        ...
        <>
            <Modal.Header>How would you rate Polaris RZR Storage Bags SET of 2?</Modal.Header>
            <Modal.Body>
                <div
