    ...
    return (
        <section>
            <div className="bg-[#EAE7E0] py-4 space-y-2">
                <h1 className="text-center font-semibold text-gray-800 text-2xl mx-4">
                    Share your experience with our{' '}
                    <span className="uppercase text-orange-400 font-bold  ">
                        Polaris RZR Storage Bags SET of 2
                    </span>{' '}
                    and get a FREE
                    <span className="uppercase text-orange-400 font-bold  ">
                        {' '}
                        Dual USB Charger for Polaris RZR
                    </span>
                </h1>
            ...
            <div className="flex flex-col md:justify-center  md:flex-row">
                <div className="flex flex-col items-center mt-20 h-fit shadow-xl">
                    <Swiper loop className="mySwiper w-[380px]">
                        <SwiperSlide>
                            <Image
                                src="/dual-charger/dual-charger.jpg"
                                width={380}
                                height={380}
                                alt="Gift"
                    ...
                    <p className="uppercase text-gray-800 font-bold md:rounded-b-md -mt-2 text-lg py-2 bg-[#EAE7E0] w-full text-center ">
                        Dual USB Charger for Polaris RZR
                    </p>
                </div>
                <form
                    onSubmit={submitHandler}
                    className=" w-screen md:w-[900px] bg-[#EAE7E0] md:ml-20   my-10 md:p-5 p-2  "
                >
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setUserInfo({ ...userInfo, 'Full Name': e.target.value })
                            }
                            required
                        />
                    </div>
